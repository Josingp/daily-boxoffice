            ...
            <div className="grid grid-cols-2 gap-y-4 gap-x-2 relative z-10">
              ...
              <div>
                ...
                <p className="font-bold text-lg">
                  {formatNumber(parseInt((reservation.audiCnt || '0').replace(/,/g, '')))}명
                </p>
              </div>
              ...
              <div>
                ...
                <p className="font-bold text-lg">
                  {formatNumber(parseInt((reservation.audiAcc || '0').replace(/,/g, '')))}명
                </p>
              </div>
              ...
              <div>
                ...
                <p className="font-medium text-sm text-indigo-100">
                  {formatKoreanNumber(parseInt((reservation.salesAmt || '0').replace(/,/g, '')))}원
                </p>
              </div>
               ...
               <div>
                ...
                <p className="font-medium text-sm text-indigo-100">
                  {formatKoreanNumber(parseInt((reservation.salesAcc || '0').replace(/,/g, '')))}원
                </p>
              </div>
            </div>
          </div>
